...
import { LayoutDashboard, Stethoscope, BrainCircuit, Calendar, Timeline, CalendarDays, Users, UserCog, CalendarCheck, CalendarX, ChevronLeft, LogOut } from 'lucide-react';
...
export default function AppSidebar({ navigation, role, userName }: AppSidebarProps) {
